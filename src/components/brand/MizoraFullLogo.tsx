...
type MizoraFullLogoProps = {
  /** Total lockup width (wordmark + runner). */
  width?: number;
  runnerVariant?: 'black' | 'figma';
};
...
/**
 * Figma `Mizora_Full logo` — Satoshi wordmark + runner mark (SVG).
 */
export function MizoraFullLogo({ width = 248, runnerVariant = 'black' }: MizoraFullLogoProps) {
  ...
  const gap = 4 * scale;
  const runnerFill = runnerVariant === 'figma' ? '#C1FD3A' : '#000000';

  return (
    <View
      accessibilityRole="image"
      accessibilityLabel="Mizora"
      style={{ flexDirection: 'row', alignItems: 'center', width, gap }}
    >
      <Text
        style={{
      ...
      >
        ...
        />
        <Path
          d="M89.2275 37.6703C89.5497 37.6112 89.6826 37.5497 89.9722 37.6955C90.362 38.6744 90.7327 40.3405 91.0313 41.4062C91.4256 42.8131 91.9394 44.3855 92.2402 45.7943C98.1158 45.9671 103.991 46.1784 109.865 46.4281C112.392 46.5174 117.206 46.4928 119.442 46.8323L119.515 47.0171C119.164 47.8537 116.334 48.2548 115.388 48.4882L110.506 49.7286C106.352 50.7937 102.191 51.8308 98.0234 52.84C95.0039 53.545 92.0475 54.3636 88.9909 55.0603C87.2997 53.6734 85.3934 52.4186 83.647 51.1075C78.9792 47.603 73.7424 44.207 69.2188 40.5936C75.8504 39.7534 82.5969 38.6508 89.2275 37.6703Z"
          fill={runnerFill}
        />
        <Path
          d="M87.3315 10.7436C92.3396 10.0832 96.9341 13.6095 97.591 18.6182C98.249 23.6267 94.7191 28.2192 89.7099 28.8733C84.7052 29.5269 80.1185 26.0015 79.4616 20.9974C78.8048 15.9932 82.3268 11.4035 87.3315 10.7436Z"
          fill={runnerFill}
        />
      </Svg>
    </View>
