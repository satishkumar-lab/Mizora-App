...
/** Outline flame — 1.5px stroke, same family as CalendarOutlineIcon / BackChevronIcon. */
export function FlameOutlineIcon({ size = 16, color = BACK_CHEVRON_COLOR }: FlameOutlineIconProps) {
  return (
